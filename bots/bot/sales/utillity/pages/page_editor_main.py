import page
from bots.bot.sales.utillity.pages.display import DisplayGenerator, DisplayParser

def gen_display():
    display_gen = DisplayGenerator()
    for menu_number in range(1,4):
        display_gen.add_page_as_file(f"../../storage/pages/menus/menu{menu_number}/page1.conf")
...
def gen_page(page_number: int,menu_number: int):
    ...
    page_gen.set_image_filename(f"storage/images/{page_number}.jpg")
    ...
    page_gen.save(f"../../storage/pages/menus/menu{menu_number}/page{page_number}.conf")
